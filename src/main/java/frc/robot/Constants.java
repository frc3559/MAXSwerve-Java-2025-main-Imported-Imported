...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kTrackWidth = Units.inchesToMeters(25.375);
    ...
    public static final int kGrabberWheelCanId = 22;
    public static final int kElevatorJointCanId = 24;
...
//MMotor stands for Miscellaneous Motor. These are obscure details about motors, usually determining speed.
  public static final class MMotorConstants {
    public static final double kDriveDeadband = 0.05;
//######################## Remember to change this value for competition! ##################### 
    public static final double kDriveSpeedModifier = 1;
    public static final double kArmWheelSpeedModifier = 0.5;
    public static final double kGrabberWheelOutSpeed = 0.7;
    public static final double kGrabberWheelInSpeed = 0.4;
    public static final double kGrabberJointSpeed = 0.25;
    public static final double kClimberSpeedModifier = 1;
  }
